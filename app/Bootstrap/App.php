...
class App
{
    ...
    private function registerRoutes(): void
    {
        ...
        $this->router->get('/admin/inbox/poll', 'App\Controllers\Admin\InboxController@poll');
        ...
        $this->router->post('/admin/edition/{date}/reorder', 'App\Controllers\Admin\EditionController@reorder');
        ...
        $this->router->get('/editions/partial', 'App\Controllers\EditionArchiveController@partial');
