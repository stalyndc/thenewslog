...
class Container_d16b1d9ad7 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d16b1d9ad7 $container)
			{
	...
	public function createServiceContainer(): Container_d16b1d9ad7
	{
		return $this;
	}
